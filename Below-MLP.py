...
feature_names = [ 'TG','BMI','ABCB1_rs1128503_AA', 'ABCB1_rs1128503_AG',
       'ABCB1_rs1128503_GG', 'mTOR_rs2076655_GG', 'mTOR_rs2076655_AG',
       'mTOR_rs2076655_AA', 'IL10_rs1800896_CT']

TG = st.number_input("TG (mmol/L):", min_value=0.00, max_value=6.00, value=3.00)
...
#IL10_rs1800896_CT = st.number_input("IL-10.rs1800896 (1=TT,2=CT):", min_value=1, max_value=2, value=1)
IL10_rs1800896_CT = st.selectbox("IL-10.rs1800896_CT:", options=[1, 2], format_func=lambda x: 'No' if x == 1 else 'Yes')


# 准备输入特征
feature_values = [ TG,BMI,ABCB1_rs1128503_AA, ABCB1_rs1128503_AG,
       ABCB1_rs1128503_GG, mTOR_rs2076655_GG, mTOR_rs2076655_AG,
       mTOR_rs2076655_AA, IL10_rs1800896_CT]
features = np.array([feature_values])

# 分离连续变量和分类变量
continuous_features = [TG,BMI]
...
continuous_features_df = pd.DataFrame(continuous_features_array, columns=['TG','BMI'])
